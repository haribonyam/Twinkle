...
public class QFileEntity extends EntityPathBase<FileEntity> {
    ...
    private static final long serialVersionUID = 969057889L;
    ...
    public final QSnsPostEntity snsPost;
    ...
    public QFileEntity(Class<? extends FileEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.snsPost = inits.isInitialized("snsPost") ? new QSnsPostEntity(forProperty("snsPost")) : null;
    }
